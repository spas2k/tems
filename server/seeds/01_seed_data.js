...
exports.seed = async function (knex) {
  ...
  await knex('usoc_codes').insert([
    ...
    { usoc_codes_id: 2,  usoc_code: 'MPLS1',   description: 'MPLS Port — Standard',                    category: 'Transport',  sub_category: 'MPLS',       default_mrc: 1850.00,  default_nrc: 500.00,  unit: 'per circuit', status: 'Active' },
    { usoc_codes_id: 3,  usoc_code: 'DIA1G',   description: 'Dedicated Internet Access — 1 Gbps',      category: 'Access',     sub_category: 'DIA',        default_mrc: 750.00,   default_nrc: 350.00,  unit: 'per circuit', status: 'Active' },
    { usoc_codes_id: 4,  usoc_code: 'PIP200',  description: 'Private IP — 200 Mbps',                   category: 'Transport',  sub_category: 'Private IP', default_mrc: 2200.00,  default_nrc: 450.00,  unit: 'per circuit', status: 'Active' },
    { usoc_codes_id: 5,  usoc_code: 'WAVE1G',  description: 'Wavelength Service — 1 Gbps',             category: 'Transport',  sub_category: 'Wavelength', default_mrc: 4500.00,  default_nrc: 1000.00, unit: 'per circuit', status: 'Active' },
    ...
    { usoc_codes_id: 7,  usoc_code: 'WRLSS55', description: 'Wireless Business Line — Unlimited',      category: 'Wireless',   sub_category: 'Voice+Data', default_mrc: 55.00,    default_nrc: 0.00,    unit: 'per line',    status: 'Active' },
    ...
    { usoc_codes_id: 9,  usoc_code: 'SDWN2',   description: 'SD-WAN Managed Service — Enhanced',       category: 'Transport',  sub_category: 'SD-WAN',     default_mrc: 980.00,   default_nrc: 500.00,  unit: 'per site',    status: 'Active' },
    ...
    { usoc_codes_id: 11, usoc_code: 'COAX300', description: 'Coax Internet — 300 Mbps',                category: 'Access',     sub_category: 'Cable',      default_mrc: 445.00,   default_nrc: 100.00,  unit: 'per site',    status: 'Active' },
    ...
    { usoc_codes_id: 16, usoc_code: 'WRLSS45', description: 'Wireless Business Line — Standard',       category: 'Wireless',   sub_category: 'Voice+Data', default_mrc: 45.00,    default_nrc: 0.00,    unit: 'per line',    status: 'Active' },
    { usoc_codes_id: 17, usoc_code: 'WAVE10G', description: 'Wavelength Service — 10 Gbps',            category: 'Transport',  sub_category: 'Wavelength', default_mrc: 4500.00,  default_nrc: 1500.00, unit: 'per circuit', status: 'Active' },
    { usoc_codes_id: 18, usoc_code: 'MPLS50',  description: 'MPLS Port — 50 Mbps',                     category: 'Transport',  sub_category: 'MPLS',       default_mrc: 1850.00,  default_nrc: 500.00,  unit: 'per circuit', status: 'Active' },
  ]);

  // ── contracts (with new Phase A columns: minimum_spend, etf_amount, commitment_type) ──
  ...
  // ── contract_rates — per-USOC rate schedule per contract ──
  await knex('contract_rates').insert([
    // Contract 1: AT&T MPLS — USOC MPLS1 (100Mbps) & MPLS50 (50Mbps)
    ...
    // Contract 2: AT&T DIA — USOC DIA1G
    ...
    // Contract 3: Verizon PIP — USOC PIP200
    ...
    // Contract 4: Lumen Wave — USOC WAVE1G & WAVE10G
    ...
    { contract_rates_id: 6,  contracts_id: 4,  usoc_codes_id: 17, mrc: 4500.00, nrc: 1500.00, effective_date: '2024-01-01', expiration_date: '2027-12-31', notes: 'Wavelength 10 Gbps — same MRC, higher NRC' },
    // Contract 5: Comcast SD-WAN — USOC SDWAN
    ...
    // Contract 6: Verizon Wireless Fleet — USOC WRLSS45
    ...
    // Contract 7: Zayo Dark Fiber — USOC DKFBR
    ...
    // Contract 8: Windstream SD-WAN — USOC SDWN2
    ...
    // Contract 9: T-Mobile Wireless — USOC WRLSS55
    ...
    // Contract 10: Crown Castle Small Cell — USOC SCELL
    ...
    // Contract 11: Spectrum Coax — USOC COAX300
    ...
    // Contract 12: AT&T MSS — USOC MSEC
  ...
  await knex('orders').insert([
    { orders_id: 1,  accounts_id: 1, contracts_id: 1,  circuits_id: null, order_number: 'ORD-2023-0001', description: 'MPLS Circuit - Chicago HQ',                   contracted_rate: 1850.00, order_date: '2023-01-20', due_date: '2023-02-10', status: 'Completed',   notes: 'Standard install, no issues' },
    { orders_id: 2,  accounts_id: 1, contracts_id: 1,  circuits_id: null, order_number: 'ORD-2023-0002', description: 'MPLS Circuit - Dallas Branch',                 contracted_rate: 1850.00, order_date: '2023-03-01', due_date: '2023-03-15', status: 'Completed',   notes: '' },
    { orders_id: 3,  accounts_id: 2, contracts_id: 3,  circuits_id: null, order_number: 'ORD-2022-0041', description: 'Verizon Private IP - NY Office',               contracted_rate: 2200.00, order_date: '2022-09-05', due_date: '2022-10-01', status: 'Completed',   notes: 'Expedited install requested' },
    { orders_id: 4,  accounts_id: 3, contracts_id: 4,  circuits_id: null, order_number: 'ORD-2024-0011', description: 'Lumen Wavelength - Chicago DC',                contracted_rate: 4500.00, order_date: '2024-01-05', due_date: '2024-02-01', status: 'Completed',   notes: 'Data center cross connect included' },
    { orders_id: 5,  accounts_id: 4, contracts_id: 5,  circuits_id: null, order_number: 'ORD-2023-0088', description: 'Comcast SD-WAN - Phoenix Branch',              contracted_rate: 620.00,  order_date: '2023-08-01', due_date: '2023-08-20', status: 'Completed',   notes: '' },
    { orders_id: 6,  accounts_id: 1, contracts_id: 2,  circuits_id: null, order_number: 'ORD-2026-0012', description: 'AT&T DIA 1Gbps - Austin Office',               contracted_rate: 750.00,  order_date: '2026-01-15', due_date: '2026-03-01', status: 'In Progress', notes: 'Awaiting local loop provisioning' },
    { orders_id: 7,  accounts_id: 5, contracts_id: 7,  circuits_id: null, order_number: 'ORD-2023-0071', description: 'Zayo Dark Fiber — Denver to Chicago route',    contracted_rate: 8500.00, order_date: '2023-08-05', due_date: '2023-09-30', status: 'Completed',   notes: 'Cross-connect included at both ends' },
    { orders_id: 8,  accounts_id: 6, contracts_id: 8,  circuits_id: null, order_number: 'ORD-2024-0031', description: 'Windstream SD-WAN — Seattle HQ',               contracted_rate: 980.00,  order_date: '2024-01-20', due_date: '2024-02-28', status: 'Completed',   notes: 'Managed CPE deployed on-site' },
    { orders_id: 9,  accounts_id: 6, contracts_id: 8,  circuits_id: null, order_number: 'ORD-2024-0032', description: 'Windstream SD-WAN — Denver Branch',            contracted_rate: 980.00,  order_date: '2024-02-01', due_date: '2024-03-15', status: 'Completed',   notes: '' },
    { orders_id: 10, accounts_id: 7, contracts_id: 9,  circuits_id: null, order_number: 'ORD-2024-0055', description: 'T-Mobile Business — Initial Fleet (25 lines)', contracted_rate: 55.00,   order_date: '2024-03-20', due_date: '2024-04-01', status: 'Completed',   notes: 'MDM enrolled all devices' },
    { orders_id: 11, accounts_id: 8, contracts_id: 10, circuits_id: null, order_number: 'ORD-2024-0099', description: 'Crown Castle — Small Cell Node NYC-Midtown',   contracted_rate: 3200.00, order_date: '2024-06-10', due_date: '2024-09-01', status: 'Completed',   notes: 'City permit required — 90-day lead time' },
    { orders_id: 12, accounts_id: 6, contracts_id: 8,  circuits_id: null, order_number: 'ORD-2026-0021', description: 'Windstream SD-WAN — Portland New Site',        contracted_rate: 980.00,  order_date: '2026-01-10', due_date: '2026-03-15', status: 'In Progress', notes: 'Local loop order placed 1/12/26' },
    { orders_id: 13, accounts_id: 1, contracts_id: 1,  circuits_id: null, order_number: 'ORD-2026-0013', description: 'AT&T MPLS Upgrade — Chicago HQ 100→500 Mbps', contracted_rate: 1850.00, order_date: '2026-01-25', due_date: '2026-03-10', status: 'In Progress', notes: 'Bandwidth upgrade, same circuit ID' },
    { orders_id: 14, accounts_id: 3, contracts_id: 4,  circuits_id: null, order_number: 'ORD-2026-0014', description: 'Lumen Wave — Los Angeles Data Center',         contracted_rate: 4500.00, order_date: '2026-02-01', due_date: '2026-04-15', status: 'In Progress', notes: 'New colocation cross-connect required' },
    { orders_id: 15, accounts_id: 2, contracts_id: 3,  circuits_id: null, order_number: 'ORD-2025-0088', description: 'Verizon Private IP — Miami Office (cancelled)',contracted_rate: 2200.00, order_date: '2025-11-01', due_date: '2026-01-15', status: 'Cancelled',   notes: 'Office lease not renewed; order cancelled' },
  ]);

  // ── circuits ──────────────────────────────────────────────
  await knex('circuits').insert([
    { circuits_id: 1,  accounts_id: 1, contracts_id: 1,  orders_id: 1,    circuit_number: 'ATT/MPLS/00112233',  type: 'MPLS',       bandwidth: '100 Mbps', location: 'Chicago, IL - HQ',              contracted_rate: 1850.00, status: 'Active',       install_date: '2023-02-10', disconnect_date: null },
    { circuits_id: 2,  accounts_id: 1, contracts_id: 1,  orders_id: 2,    circuit_number: 'ATT/MPLS/00445566',  type: 'MPLS',       bandwidth: '50 Mbps',  location: 'Dallas, TX - Branch',           contracted_rate: 1850.00, status: 'Active',       install_date: '2023-03-15', disconnect_date: null },
    { circuits_id: 3,  accounts_id: 2, contracts_id: 3,  orders_id: 3,    circuit_number: 'VZ/PIP/887722AA',    type: 'Private IP', bandwidth: '200 Mbps', location: 'New York, NY - Office',         contracted_rate: 2200.00, status: 'Active',       install_date: '2022-10-01', disconnect_date: null },
    { circuits_id: 4,  accounts_id: 3, contracts_id: 4,  orders_id: 4,    circuit_number: 'LMN/WAVE/00FFAA12',  type: 'Wavelength', bandwidth: '1 Gbps',   location: 'Chicago, IL - DataCenter',      contracted_rate: 4500.00, status: 'Active',       install_date: '2024-02-01', disconnect_date: null },
    { circuits_id: 5,  accounts_id: 4, contracts_id: 5,  orders_id: 5,    circuit_number: 'CMB/SDWAN/3301XQ',   type: 'SD-WAN',     bandwidth: '500 Mbps', location: 'Phoenix, AZ - Branch',          contracted_rate: 620.00,  status: 'Active',       install_date: '2023-08-20', disconnect_date: null },
    { circuits_id: 6,  accounts_id: 1, contracts_id: 2,  orders_id: 6,    circuit_number: 'ATT/DIA/77BB1199',   type: 'DIA',        bandwidth: '1 Gbps',   location: 'Austin, TX - Office',           contracted_rate: 750.00,  status: 'Pending',      install_date: null,         disconnect_date: null },
    { circuits_id: 7,  accounts_id: 5, contracts_id: 7,  orders_id: 7,    circuit_number: 'ZYO/FIBER/DEN-CHI-001', type: 'Dark Fiber', bandwidth: '10 Gbps', location: 'Denver, CO → Chicago, IL',     contracted_rate: 8500.00, status: 'Active',       install_date: '2023-09-30', disconnect_date: null },
    { circuits_id: 8,  accounts_id: 6, contracts_id: 8,  orders_id: 8,    circuit_number: 'WNS/SDWAN/SEA-001',  type: 'SD-WAN',     bandwidth: '500 Mbps', location: 'Seattle, WA — HQ',              contracted_rate: 980.00,  status: 'Active',       install_date: '2024-02-28', disconnect_date: null },
    { circuits_id: 9,  accounts_id: 6, contracts_id: 8,  orders_id: 9,    circuit_number: 'WNS/SDWAN/DEN-001',  type: 'SD-WAN',     bandwidth: '200 Mbps', location: 'Denver, CO — Branch',           contracted_rate: 980.00,  status: 'Active',       install_date: '2024-03-15', disconnect_date: null },
    { circuits_id: 10, accounts_id: 7, contracts_id: 9,  orders_id: 10,   circuit_number: 'TMO/WRLSS/FLEET-A01',type: 'Wireless',   bandwidth: '4G/5G',    location: 'Mobile Fleet — Group A (10 lines)', contracted_rate: 55.00, status: 'Active',     install_date: '2024-04-01', disconnect_date: null },
    { circuits_id: 11, accounts_id: 7, contracts_id: 9,  orders_id: 10,   circuit_number: 'TMO/WRLSS/FLEET-A02',type: 'Wireless',   bandwidth: '4G/5G',    location: 'Mobile Fleet — Group B (10 lines)', contracted_rate: 55.00, status: 'Active',     install_date: '2024-04-01', disconnect_date: null },
    { circuits_id: 12, accounts_id: 7, contracts_id: 9,  orders_id: 10,   circuit_number: 'TMO/WRLSS/FLEET-A03',type: 'Wireless',   bandwidth: '4G/5G',    location: 'Mobile Fleet — Group C (5 lines)',  contracted_rate: 55.00, status: 'Active',     install_date: '2024-04-01', disconnect_date: null },
    { circuits_id: 13, accounts_id: 8, contracts_id: 10, orders_id: 11,   circuit_number: 'CCF/SCELL/NYC-MDT-001',type: 'Small Cell',bandwidth: 'N/A',      location: 'New York, NY — Midtown Node',   contracted_rate: 3200.00, status: 'Active',       install_date: '2024-09-01', disconnect_date: null },
    { circuits_id: 14, accounts_id: 9, contracts_id: 11, orders_id: null,  circuit_number: 'SPE/COAX/LA-0071',   type: 'Coax/Cable', bandwidth: '300 Mbps', location: 'Los Angeles, CA — West Office',  contracted_rate: 445.00,  status: 'Disconnected', install_date: '2022-12-15', disconnect_date: '2025-11-19' },
    { circuits_id: 15, accounts_id: 3, contracts_id: 4,  orders_id: 14,   circuit_number: 'LMN/WAVE/LAX-DC-001',type: 'Wavelength', bandwidth: '10 Gbps',  location: 'Los Angeles, CA — DataCenter',  contracted_rate: 4500.00, status: 'Pending',      install_date: null,         disconnect_date: null },
  ]);

  // Link completed orders → circuits
  await knex('orders').where('orders_id', 1).update({ circuits_id: 1 });
  await knex('orders').where('orders_id', 2).update({ circuits_id: 2 });
  await knex('orders').where('orders_id', 3).update({ circuits_id: 3 });
  await knex('orders').where('orders_id', 4).update({ circuits_id: 4 });
  await knex('orders').where('orders_id', 5).update({ circuits_id: 5 });
  await knex('orders').where('orders_id', 6).update({ circuits_id: 6 });
  await knex('orders').where('orders_id', 7).update({ circuits_id: 7 });
  await knex('orders').where('orders_id', 8).update({ circuits_id: 8 });
  await knex('orders').where('orders_id', 9).update({ circuits_id: 9 });
  await knex('orders').where('orders_id', 10).update({ circuits_id: 10 });
  await knex('orders').where('orders_id', 11).update({ circuits_id: 11 });
  ...
  // ── line_items (with Phase A columns: usoc_codes_id, mrc_amount, nrc_amount, audit_status) ──
  await knex('line_items').insert([
    // Invoice 1 – AT&T January (Paid)
    { line_items_id: 1,  invoices_id: 1, circuits_id: 1,    usoc_codes_id: 2,    description: 'MPLS MRC - Chicago HQ',    charge_type: 'MRC',          amount: 1850.00, mrc_amount: 1850.00, nrc_amount: null,  contracted_rate: 1850.00, variance: 0.00,   audit_status: 'Validated', period_start: '2026-01-01', period_end: '2026-01-31' },
    { line_items_id: 2,  invoices_id: 1, circuits_id: 2,    usoc_codes_id: 18,   description: 'MPLS MRC - Dallas Branch',  charge_type: 'MRC',          amount: 1850.00, mrc_amount: 1850.00, nrc_amount: null,  contracted_rate: 1850.00, variance: 0.00,   audit_status: 'Validated', period_start: '2026-01-01', period_end: '2026-01-31' },
    { line_items_id: 3,  invoices_id: 1, circuits_id: null,  usoc_codes_id: 13,   description: 'Federal USF Surcharge',     charge_type: 'Tax/Surcharge',amount: 190.00,  mrc_amount: 190.00,  nrc_amount: null,  contracted_rate: null,    variance: null,   audit_status: null,        period_start: '2026-01-01', period_end: '2026-01-31' },
    // Invoice 2 – AT&T February (Open, has variance)
    { line_items_id: 4,  invoices_id: 2, circuits_id: 1,    usoc_codes_id: 2,    description: 'MPLS MRC - Chicago HQ',     charge_type: 'MRC',          amount: 1850.00, mrc_amount: 1850.00, nrc_amount: null,  contracted_rate: 1850.00, variance: 0.00,   audit_status: 'Validated', period_start: '2026-02-01', period_end: '2026-02-28' },
    { line_items_id: 5,  invoices_id: 2, circuits_id: 2,    usoc_codes_id: 18,   description: 'MPLS MRC - Dallas Branch',   charge_type: 'MRC',          amount: 2080.00, mrc_amount: 2080.00, nrc_amount: null,  contracted_rate: 1850.00, variance: 230.00, audit_status: 'Variance',  period_start: '2026-02-01', period_end: '2026-02-28' },
    { line_items_id: 6,  invoices_id: 2, circuits_id: null,  usoc_codes_id: 13,   description: 'Federal USF Surcharge',     charge_type: 'Tax/Surcharge',amount: 190.00,  mrc_amount: 190.00,  nrc_amount: null,  contracted_rate: null,    variance: null,   audit_status: null,        period_start: '2026-02-01', period_end: '2026-02-28' },
    // Invoice 3 – Verizon January (Paid)
    { line_items_id: 7,  invoices_id: 3, circuits_id: 3,    usoc_codes_id: 4,    description: 'Verizon Private IP MRC',     charge_type: 'MRC',          amount: 2200.00, mrc_amount: 2200.00, nrc_amount: null,  contracted_rate: 2200.00, variance: 0.00,   audit_status: 'Validated', period_start: '2026-01-01', period_end: '2026-01-31' },
    { line_items_id: 8,  invoices_id: 3, circuits_id: null,  usoc_codes_id: 14,   description: 'State Taxes',               charge_type: 'Tax/Surcharge',amount: 65.50,   mrc_amount: 65.50,   nrc_amount: null,  contracted_rate: null,    variance: null,   audit_status: null,        period_start: '2026-01-01', period_end: '2026-01-31' },
    // Invoice 4 – Verizon February (Open, has variance)
    { line_items_id: 9,  invoices_id: 4, circuits_id: 3,    usoc_codes_id: 4,    description: 'Verizon Private IP MRC',     charge_type: 'MRC',          amount: 2245.00, mrc_amount: 2245.00, nrc_amount: null,  contracted_rate: 2200.00, variance: 45.00,  audit_status: 'Variance',  period_start: '2026-02-01', period_end: '2026-02-28' },
    { line_items_id: 10, invoices_id: 4, circuits_id: null,  usoc_codes_id: 14,   description: 'State Taxes',               charge_type: 'Tax/Surcharge',amount: 65.00,   mrc_amount: 65.00,   nrc_amount: null,  contracted_rate: null,    variance: null,   audit_status: null,        period_start: '2026-02-01', period_end: '2026-02-28' },
    // Invoice 5 – Lumen February (Open)
    { line_items_id: 11, invoices_id: 5, circuits_id: 4,    usoc_codes_id: 5,    description: 'Lumen Wavelength MRC',       charge_type: 'MRC',          amount: 4500.00, mrc_amount: 4500.00, nrc_amount: null,  contracted_rate: 4500.00, variance: 0.00,   audit_status: 'Validated', period_start: '2026-02-01', period_end: '2026-02-28' },
    // Invoice 6 – Comcast February (Disputed)
    { line_items_id: 12, invoices_id: 6, circuits_id: 5,    usoc_codes_id: 6,    description: 'Comcast SD-WAN MRC',         charge_type: 'MRC',          amount: 645.00,  mrc_amount: 645.00,  nrc_amount: null,  contracted_rate: 620.00,  variance: 25.00,  audit_status: 'Variance',  period_start: '2026-02-01', period_end: '2026-02-28' },
    // Invoice 7 – Zayo January (Paid)
    { line_items_id: 13, invoices_id: 7,  circuits_id: 7,   usoc_codes_id: 8,    description: 'Zayo Dark Fiber MRC — Denver-Chicago',      charge_type: 'MRC',          amount: 8500.00, mrc_amount: 8500.00, nrc_amount: null,  contracted_rate: 8500.00, variance: 0.00,   audit_status: 'Validated', period_start: '2026-01-01', period_end: '2026-01-31' },
    // Invoice 8 – Zayo February (Open)
    { line_items_id: 14, invoices_id: 8,  circuits_id: 7,   usoc_codes_id: 8,    description: 'Zayo Dark Fiber MRC — Denver-Chicago',      charge_type: 'MRC',          amount: 8500.00, mrc_amount: 8500.00, nrc_amount: null,  contracted_rate: 8500.00, variance: 0.00,   audit_status: 'Validated', period_start: '2026-02-01', period_end: '2026-02-28' },
    // Invoice 9 – Windstream January (Paid)
    { line_items_id: 15, invoices_id: 9,  circuits_id: 8,   usoc_codes_id: 9,    description: 'Windstream SD-WAN MRC — Seattle HQ',        charge_type: 'MRC',          amount: 980.00,  mrc_amount: 980.00,  nrc_amount: null,  contracted_rate: 980.00,  variance: 0.00,   audit_status: 'Validated', period_start: '2026-01-01', period_end: '2026-01-31' },
    { line_items_id: 16, invoices_id: 9,  circuits_id: 9,   usoc_codes_id: 9,    description: 'Windstream SD-WAN MRC — Denver Branch',     charge_type: 'MRC',          amount: 980.00,  mrc_amount: 980.00,  nrc_amount: null,  contracted_rate: 980.00,  variance: 0.00,   audit_status: 'Validated', period_start: '2026-01-01', period_end: '2026-01-31' },
    { line_items_id: 17, invoices_id: 9,  circuits_id: null, usoc_codes_id: 15,   description: 'Taxes & Regulatory Fees',                  charge_type: 'Tax/Surcharge',amount: 80.00,   mrc_amount: 80.00,   nrc_amount: null,  contracted_rate: null,    variance: null,   audit_status: null,        period_start: '2026-01-01', period_end: '2026-01-31' },
    // Invoice 10 – Windstream February (Disputed)
    { line_items_id: 18, invoices_id: 10, circuits_id: 8,   usoc_codes_id: 9,    description: 'Windstream SD-WAN MRC — Seattle HQ',        charge_type: 'MRC',          amount: 1050.00, mrc_amount: 1050.00, nrc_amount: null,  contracted_rate: 980.00,  variance: 70.00,  audit_status: 'Variance',  period_start: '2026-02-01', period_end: '2026-02-28' },
    { line_items_id: 19, invoices_id: 10, circuits_id: 9,   usoc_codes_id: 9,    description: 'Windstream SD-WAN MRC — Denver Branch',     charge_type: 'MRC',          amount: 975.00,  mrc_amount: 975.00,  nrc_amount: null,  contracted_rate: 980.00,  variance: -5.00,  audit_status: 'Validated', period_start: '2026-02-01', period_end: '2026-02-28' },
    { line_items_id: 20, invoices_id: 10, circuits_id: null, usoc_codes_id: 15,   description: 'Taxes & Regulatory Fees',                  charge_type: 'Tax/Surcharge',amount: 80.00,   mrc_amount: 80.00,   nrc_amount: null,  contracted_rate: null,    variance: null,   audit_status: null,        period_start: '2026-02-01', period_end: '2026-02-28' },
    // Invoice 11 – T-Mobile February (Open)
    { line_items_id: 21, invoices_id: 11, circuits_id: 10,  usoc_codes_id: 7,    description: 'T-Mobile Wireless — Fleet Group A (10 ln)', charge_type: 'MRC',          amount: 550.00,  mrc_amount: 550.00,  nrc_amount: null,  contracted_rate: 550.00,  variance: 0.00,   audit_status: 'Validated', period_start: '2026-02-01', period_end: '2026-02-28' },
    { line_items_id: 22, invoices_id: 11, circuits_id: 11,  usoc_codes_id: 7,    description: 'T-Mobile Wireless — Fleet Group B (10 ln)', charge_type: 'MRC',          amount: 550.00,  mrc_amount: 550.00,  nrc_amount: null,  contracted_rate: 550.00,  variance: 0.00,   audit_status: 'Validated', period_start: '2026-02-01', period_end: '2026-02-28' },
    { line_items_id: 23, invoices_id: 11, circuits_id: 12,  usoc_codes_id: 7,    description: 'T-Mobile Wireless — Fleet Group C (5 ln)',  charge_type: 'MRC',          amount: 275.00,  mrc_amount: 275.00,  nrc_amount: null,  contracted_rate: 275.00,  variance: 0.00,   audit_status: 'Validated', period_start: '2026-02-01', period_end: '2026-02-28' },
    // Invoice 12 – Crown Castle February (Paid)
    { line_items_id: 24, invoices_id: 12, circuits_id: 13,  usoc_codes_id: 10,   description: 'Crown Castle Small Cell Node — NYC Midtown', charge_type: 'MRC',         amount: 3200.00, mrc_amount: 3200.00, nrc_amount: null,  contracted_rate: 3200.00, variance: 0.00,   audit_status: 'Validated', period_start: '2026-02-01', period_end: '2026-02-28' },
    // Invoice 13 – Spectrum November 2025 (Paid)
    { line_items_id: 25, invoices_id: 13, circuits_id: 14,  usoc_codes_id: 11,   description: 'Spectrum Business Coax — LA West Office',   charge_type: 'MRC',          amount: 445.00,  mrc_amount: 445.00,  nrc_amount: null,  contracted_rate: 445.00,  variance: 0.00,   audit_status: 'Validated', period_start: '2025-11-01', period_end: '2025-11-30' },
    // Invoice 14 – AT&T December 2025 historical
    { line_items_id: 26, invoices_id: 14, circuits_id: 1,   usoc_codes_id: 2,    description: 'AT&T MPLS MRC — Chicago HQ',               charge_type: 'MRC',          amount: 1850.00, mrc_amount: 1850.00, nrc_amount: null,  contracted_rate: 1850.00, variance: 0.00,   audit_status: 'Validated', period_start: '2025-12-01', period_end: '2025-12-31' },
    { line_items_id: 27, invoices_id: 14, circuits_id: 2,   usoc_codes_id: 18,   description: 'AT&T MPLS MRC — Dallas Branch',             charge_type: 'MRC',          amount: 1850.00, mrc_amount: 1850.00, nrc_amount: null,  contracted_rate: 1850.00, variance: 0.00,   audit_status: 'Validated', period_start: '2025-12-01', period_end: '2025-12-31' },
    { line_items_id: 28, invoices_id: 14, circuits_id: null, usoc_codes_id: 13,   description: 'Federal USF Surcharge',                    charge_type: 'Tax/Surcharge',amount: 190.00,  mrc_amount: 190.00,  nrc_amount: null,  contracted_rate: null,    variance: null,   audit_status: null,        period_start: '2025-12-01', period_end: '2025-12-31' },
    // Invoice 15 – Verizon December 2025 historical
    { line_items_id: 29, invoices_id: 15, circuits_id: 3,   usoc_codes_id: 4,    description: 'Verizon Private IP MRC — NY Office',        charge_type: 'MRC',          amount: 2200.00, mrc_amount: 2200.00, nrc_amount: null,  contracted_rate: 2200.00, variance: 0.00,   audit_status: 'Validated', period_start: '2025-12-01', period_end: '2025-12-31' },
    { line_items_id: 30, invoices_id: 15, circuits_id: null, usoc_codes_id: 14,   description: 'State Taxes',                              charge_type: 'Tax/Surcharge',amount: 65.50,   mrc_amount: 65.50,   nrc_amount: null,  contracted_rate: null,    variance: null,   audit_status: null,        period_start: '2025-12-01', period_end: '2025-12-31' },
  ]);
  ...
  await knex('allocations').insert([
    ...
    { allocations_id: 13, line_items_id: 15, cost_center: 'CC-100 - IT Infrastructure', department: 'Information Technology', percentage: 100.00, allocated_amount: 980.00,  notes: 'Seattle HQ — all IT' },
    ...
    { allocations_id: 16, line_items_id: 21, cost_center: 'CC-500 - Field Services',    department: 'Field Operations',        percentage: 100.00, allocated_amount: 550.00,  notes: 'Fleet Group A — field techs' },
    { allocations_id: 17, line_items_id: 22, cost_center: 'CC-500 - Field Services',    department: 'Field Operations',        percentage: 100.00, allocated_amount: 550.00,  notes: 'Fleet Group B — field techs' },
    { allocations_id: 18, line_items_id: 23, cost_center: 'CC-300 - Sales',             department: 'Sales',                   percentage: 100.00, allocated_amount: 275.00,  notes: 'Fleet Group C — sales reps' },
  ...
  await knex('cost_savings').insert([
    ...
    { cost_savings_id: 1, accounts_id: 1, circuits_id: 2,  line_items_id: 5,    invoices_id: 2,    category: 'Billing Error',         description: 'AT&T Dallas MPLS overbilled $230 vs contracted rate of $1,850/mo',       identified_date: '2026-02-10', status: 'In Progress', projected_savings: 230.00,  realized_savings: 0.00,   notes: 'Credit request submitted 2/10/26' },
    { cost_savings_id: 2, accounts_id: 2, circuits_id: 3,  line_items_id: 9,    invoices_id: 4,    category: 'Billing Error',         description: 'Verizon Private IP billing $45 over contracted rate this cycle',         identified_date: '2026-02-20', status: 'Identified',  projected_savings: 45.00,   realized_savings: 0.00,   notes: 'Need to open ticket with Verizon' },
    { cost_savings_id: 3, accounts_id: 4, circuits_id: 5,  line_items_id: 12,   invoices_id: 6,    category: 'Billing Error',         description: 'Comcast SD-WAN billed $645 vs contracted $620 — $25 overcharge',         identified_date: '2026-02-15', status: 'In Progress', projected_savings: 25.00,   realized_savings: 0.00,   notes: 'Invoice in dispute status' },
    { cost_savings_id: 4, accounts_id: 1, circuits_id: null,line_items_id: null, invoices_id: null, category: 'Contract Optimization', description: 'AT&T DIA contract renewal — market rates 15% lower than current term',    identified_date: '2026-01-30', status: 'Identified',  projected_savings: 1350.00, realized_savings: 0.00,   notes: 'Contract expires 2026-05-31; begin renegotiation Q1' },
    // seed_extra.sql cost savings
    { cost_savings_id: 5, accounts_id: 6, circuits_id: 8,   line_items_id: 18,  invoices_id: 10,   category: 'Billing Error',         description: 'Windstream billed $1,050 for Seattle SD-WAN vs contracted $980 — $70 overcharge', identified_date: '2026-02-18', status: 'In Progress', projected_savings: 70.00,   realized_savings: 0.00,   notes: 'Dispute ticket WNS-2026-0234 opened; awaiting credit memo' },
    { cost_savings_id: 6, accounts_id: 6, circuits_id: null, line_items_id: null,invoices_id: null, category: 'Contract Optimization', description: 'Windstream SD-WAN contract WNS-SDWAN-2024 expires April 2026 — benchmark shows 18% savings available with renegotiation', identified_date: '2026-02-15', status: 'Identified', projected_savings: 3528.00, realized_savings: 0.00, notes: '2-site contract at $980/site; market rate ~$800/site; 27-mo savings = $3,528' },
    { cost_savings_id: 7, accounts_id: 9, circuits_id: 14,  line_items_id: null, invoices_id: null, category: 'Service Termination',  description: 'Spectrum Coax LA — contract expired 11/19/2025, circuit disconnected. Traffic migrated to new Zayo route.', identified_date: '2025-11-20', status: 'Realized', projected_savings: 445.00, realized_savings: 445.00, notes: 'Full MRC realized monthly; no replacement cost' },
    { cost_savings_id: 8, accounts_id: 5, circuits_id: 7,   line_items_id: null, invoices_id: null, category: 'Right-Sizing',         description: 'Zayo Dark Fiber currently provisioned at 10 Gbps but peak utilization under 2 Gbps — evaluate lower-cost 1 Gbps option at contract renewal', identified_date: '2026-02-20', status: 'Identified', projected_savings: 2500.00, realized_savings: 0.00, notes: 'Contract renewal July 2027; begin analysis Q3 2026' },
    { cost_savings_id: 9, accounts_id: 7, circuits_id: null, line_items_id: null, invoices_id: null, category: 'Right-Sizing',        description: 'T-Mobile fleet has 8 inactive lines identified through MDM platform — elimination would save $440/mo', identified_date: '2026-02-22', status: 'Identified', projected_savings: 5280.00, realized_savings: 0.00, notes: '$55/line × 8 lines × 12 months = $5,280 annually; submit change order' },
  ]);
  ...
  await knex('locations').insert([
    { locations_id: 1,  name: 'Chicago HQ',              site_code: 'CHI-HQ',   site_type: 'Office',       address: '200 W Jackson Blvd',      city: 'Chicago',     state: 'IL', zip: '60606', country: 'USA', contact_name: 'Ben Carruthers',  contact_phone: '312-555-0101', contact_email: 'bcarruthers@corp.com',    status: 'Active',   notes: 'Main corporate headquarters — 8 floors' },
    { locations_id: 2,  name: 'Dallas Branch Office',    site_code: 'DAL-BR1',  site_type: 'Office',       address: '1700 Pacific Ave',         city: 'Dallas',      state: 'TX', zip: '75201', country: 'USA', contact_name: 'Gwen Fontaine',   contact_phone: '214-555-0188', contact_email: 'gfontaine@corp.com',      status: 'Active',   notes: 'Regional sales office — 2nd floor' },
    ...
    { locations_id: 4,  name: 'Austin Office',           site_code: 'AUS-OFF',  site_type: 'Office',       address: '98 San Jacinto Blvd',      city: 'Austin',      state: 'TX', zip: '78701', country: 'USA', contact_name: 'Priya Sharma',    contact_phone: '512-555-0312', contact_email: 'psharma@corp.com',        status: 'Active',   notes: 'Tech team expansion site — circuit pending' },
    ...
    { locations_id: 6,  name: 'Seattle HQ West',         site_code: 'SEA-HQ',   site_type: 'Office',       address: '1420 5th Ave',             city: 'Seattle',     state: 'WA', zip: '98101', country: 'USA', contact_name: 'Aisha Brennan',   contact_phone: '206-555-0677', contact_email: 'abrennan@corp.com',       status: 'Active',   notes: 'Western region HQ — SD-WAN primary site' },
    ...
    { locations_id: 10, name: 'NYC Midtown Small Cell',  site_code: 'NYC-SC1',  site_type: 'Remote',       address: '550 7th Ave',              city: 'New York',    state: 'NY', zip: '10018', country: 'USA', contact_name: 'Crown Castle NOC', contact_phone: '888-632-2122', contact_email: 'noc@crowncastle.com',    status: 'Active',   notes: 'Crown Castle small cell node — street-level install' },
    { locations_id: 11, name: 'Miami Office',            site_code: 'MIA-OFF',  site_type: 'Office',       address: '1 SE 3rd Ave',             city: 'Miami',       state: 'FL', zip: '33131', country: 'USA', contact_name: 'Yvette Calderon', contact_phone: '305-555-0141', contact_email: 'ycalderon@corp.com',      status: 'Inactive', notes: 'Cancelled — lease not renewed Q4 2025' },
    { locations_id: 12, name: 'Los Angeles West Office', site_code: 'LAX-OFF',  site_type: 'Office',       address: '10960 Wilshire Blvd',      city: 'Los Angeles', state: 'CA', zip: '90024', country: 'USA', contact_name: 'Derek Tanaka',    contact_phone: '310-555-0277', contact_email: 'dtanaka@corp.com',        status: 'Inactive', notes: 'Spectrum coax disconnected Nov 2025 — circuit migrated' },
    { locations_id: 13, name: 'Denver Colocation',       site_code: 'DEN-COL1', site_type: 'Colocation',   address: '910 15th St',              city: 'Denver',      state: 'CO', zip: '80202', country: 'USA', contact_name: 'Zayo NOC',        contact_phone: '844-492-9624', contact_email: 'noc@zayo.com',            status: 'Active',   notes: 'Zayo dark fiber origination point — Denver end' },
  ]);
  ...
  await knex('announcements').insert([
    { announcements_id: 1, title: 'Scheduled Maintenance — March 15, 2026',       message: 'TEMS will be offline for database maintenance from 2:00 AM – 4:00 AM CT on March 15. Plan accordingly.', type: 'warning', is_active: true,  start_date: '2026-03-10', end_date: '2026-03-15', created_by: null },
